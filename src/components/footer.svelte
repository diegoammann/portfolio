...
<div class="footer-wrapper" bind:this={footerContainer}>
    ...
    <div class="flex-wrapper">
        ...
        <div class="status-wrapper">
            ...
            {/await}
            <a class="button large-text" bind:this={fullEmailLinkElem} href="mailto:mediegoamann@gmail.com" target="_blank">mediegoamann@gmail.com</a>
        </div>
        
        <div class="credits-wrapper" bind:this={creditsElem}>
            <p class="year">© {currentYear}</p>
            <p class="credits">
                designed and developed by Diego Ammann<br>this webste is open source on github
            </p>
        </div>
    </div>
