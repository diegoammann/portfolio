			...
			<div class="flex-wrapper second">
				<h1 class = "title">
					<div class="title-mask">
						<div class="word" bind:this={titleWord1} style="text-transform: uppercase;">DIEGO</div>
					</div><br> 
					<div class="title-mask">
						<div class="word" bind:this={titleWord2} style="text-transform: uppercase;">AMMANN</div>
					</div>
				</h1>
				<div class="occupation mask">
					<p class = "paragraph" bind:this={shortDetails}>
						Frontend Engineer from Switzherland.
					</p>
				</div>
